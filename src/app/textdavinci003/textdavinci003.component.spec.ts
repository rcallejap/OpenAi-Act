...
describe('Textdavinci003Component', () => {
  ...
  it('Should set petname model through ngModel', async() => {
    // Arrange 
  ...
  it('Should call postCompletion method', async() => {
       // Arrange
    ...
    it('should call completition method when i click the generatepet button ', () => {
    // Arrange 
    component.pet = "";
  ...
  it('Should render component.result in div result', () => {
    // Arrange
